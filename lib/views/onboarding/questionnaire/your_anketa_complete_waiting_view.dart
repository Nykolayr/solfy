...
class YourAncetaCompleteWaitingView extends StatefulWidget {
  const YourAncetaCompleteWaitingView({Key? key}) : super(key: key);

  @override
  _YourAncetaCompleteWaitingViewState createState() =>
      _YourAncetaCompleteWaitingViewState();
}

class _YourAncetaCompleteWaitingViewState
    extends State<YourAncetaCompleteWaitingView> {
