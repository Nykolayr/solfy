...
class FeedDetailStackWrapper extends StatefulWidget {
  @override
  State<FeedDetailStackWrapper> createState() => _FeedDetailStackWrapperState();
}

class _FeedDetailStackWrapperState extends State<FeedDetailStackWrapper> {
