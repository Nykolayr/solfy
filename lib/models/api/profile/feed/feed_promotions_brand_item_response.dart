...
part 'feed_promotions_brand_item_response.g.dart';

@freezed
// ignore_for_file: invalid_annotation_target
class FeedPromotionsBrandItemResponse with _$FeedPromotionsBrandItemResponse {
  const factory FeedPromotionsBrandItemResponse(
  ...
  factory FeedPromotionsBrandItemResponse.fromJson(Map<String, dynamic> json) =>
      _$FeedPromotionsBrandItemResponseFromJson(json);
}
