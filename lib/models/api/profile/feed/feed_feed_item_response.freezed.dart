...
part of 'feed_feed_item_response.dart';
...
FeedFeedItemResponse _$FeedFeedItemResponseFromJson(Map<String, dynamic> json) {
  return FeedItem.fromJson(json);
}

/// @nodoc
class _$FeedFeedItemResponseTearOff {
  const _$FeedFeedItemResponseTearOff();
  ...
  FeedFeedItemResponse fromJson(Map<String, Object> json) {
    return FeedFeedItemResponse.fromJson(json);
  }
}

/// @nodoc
const $FeedFeedItemResponse = _$FeedFeedItemResponseTearOff();

/// @nodoc
mixin _$FeedFeedItemResponse {
  ...
  @JsonKey(ignore: true)
  $FeedFeedItemResponseCopyWith<FeedFeedItemResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FeedFeedItemResponseCopyWith<$Res> {
  factory $FeedFeedItemResponseCopyWith(FeedFeedItemResponse value,
          $Res Function(FeedFeedItemResponse) then) =
      _$FeedFeedItemResponseCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: "id") int? id,
      @JsonKey(name: "brand_logo") String? brandLogo,
      @JsonKey(name: "image") String? image,
...
/// @nodoc
class _$FeedFeedItemResponseCopyWithImpl<$Res>
    implements $FeedFeedItemResponseCopyWith<$Res> {
  _$FeedFeedItemResponseCopyWithImpl(this._value, this._then);

  final FeedFeedItemResponse _value;
  // ignore: unused_field
  final $Res Function(FeedFeedItemResponse) _then;
...
class _$FeedItemCopyWithImpl<$Res>
    extends _$FeedFeedItemResponseCopyWithImpl<$Res>
...
class _$FeedItem implements FeedItem {
  ...
  @override
  String toString() {
    return 'FeedFeedItemResponse(id: $id, brandLogo: $brandLogo, image: $image, title: $title, shortDescription: $shortDescription, description: $description, createdAt: $createdAt)';
  }
...
abstract class FeedItem implements FeedFeedItemResponse {
