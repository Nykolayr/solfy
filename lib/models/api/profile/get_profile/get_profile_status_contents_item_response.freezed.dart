...
part of 'get_profile_status_contents_item_response.dart';
...
GetProfileStatusContentsItemResponse
    _$GetProfileStatusContentsItemResponseFromJson(Map<String, dynamic> json) {
...
class _$GetProfileStatusContentsItemResponseTearOff {
  ...
  GetProfileStatusContentsItemResponse fromJson(Map<String, Object> json) {
    return GetProfileStatusContentsItemResponse.fromJson(json);
  }
}

/// @nodoc
const $GetProfileStatusContentsItemResponse =
    _$GetProfileStatusContentsItemResponseTearOff();

/// @nodoc
mixin _$GetProfileStatusContentsItemResponse {
  /// Заголовок
  @JsonKey(name: "title")
...
/// @nodoc
abstract class $GetProfileStatusContentsItemResponseCopyWith<$Res> {
  factory $GetProfileStatusContentsItemResponseCopyWith(
...
/// @nodoc
class _$GetProfileStatusContentsItemResponseCopyWithImpl<$Res>
    implements $GetProfileStatusContentsItemResponseCopyWith<$Res> {
  _$GetProfileStatusContentsItemResponseCopyWithImpl(this._value, this._then);

  final GetProfileStatusContentsItemResponse _value;
  // ignore: unused_field
  final $Res Function(GetProfileStatusContentsItemResponse) _then;
...
class _$StatusContentsItemCopyWithImpl<$Res>
    extends _$GetProfileStatusContentsItemResponseCopyWithImpl<$Res>
