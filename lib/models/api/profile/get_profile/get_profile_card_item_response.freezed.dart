...
part of 'get_profile_card_item_response.dart';
...
GetProfileCardItemResponse _$GetProfileCardItemResponseFromJson(
    Map<String, dynamic> json) {
  return CardItem.fromJson(json);
}

/// @nodoc
class _$GetProfileCardItemResponseTearOff {
  const _$GetProfileCardItemResponseTearOff();
  ...
  GetProfileCardItemResponse fromJson(Map<String, Object> json) {
    return GetProfileCardItemResponse.fromJson(json);
  }
}

/// @nodoc
const $GetProfileCardItemResponse = _$GetProfileCardItemResponseTearOff();

/// @nodoc
mixin _$GetProfileCardItemResponse {
  /// Идентификатор
  @JsonKey(name: "id")
  ...
  @JsonKey(ignore: true)
  $GetProfileCardItemResponseCopyWith<GetProfileCardItemResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetProfileCardItemResponseCopyWith<$Res> {
  factory $GetProfileCardItemResponseCopyWith(GetProfileCardItemResponse value,
          $Res Function(GetProfileCardItemResponse) then) =
      _$GetProfileCardItemResponseCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: "id") String? id,
      @JsonKey(name: "mask") String? mask,
      @JsonKey(name: "validity") String? validity});
...
/// @nodoc
class _$GetProfileCardItemResponseCopyWithImpl<$Res>
    implements $GetProfileCardItemResponseCopyWith<$Res> {
  _$GetProfileCardItemResponseCopyWithImpl(this._value, this._then);

  final GetProfileCardItemResponse _value;
  // ignore: unused_field
  final $Res Function(GetProfileCardItemResponse) _then;
...
class _$CardItemCopyWithImpl<$Res>
    extends _$GetProfileCardItemResponseCopyWithImpl<$Res>
...
class _$CardItem implements CardItem {
  ...
  @override
  String toString() {
    return 'GetProfileCardItemResponse(id: $id, mask: $mask, validity: $validity)';
  }
...
abstract class CardItem implements GetProfileCardItemResponse {
