...
FeedsFeedItemResponse _$FeedsFeedItemResponseFromJson(
    Map<String, dynamic> json) {
  return FeedItem.fromJson(json);
}

/// @nodoc
class _$FeedsFeedItemResponseTearOff {
  const _$FeedsFeedItemResponseTearOff();
  ...
  FeedsFeedItemResponse fromJson(Map<String, Object> json) {
    return FeedsFeedItemResponse.fromJson(json);
  }
}

/// @nodoc
const $FeedsFeedItemResponse = _$FeedsFeedItemResponseTearOff();

/// @nodoc
mixin _$FeedsFeedItemResponse {
  ...
  @JsonKey(ignore: true)
  $FeedsFeedItemResponseCopyWith<FeedsFeedItemResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FeedsFeedItemResponseCopyWith<$Res> {
  factory $FeedsFeedItemResponseCopyWith(FeedsFeedItemResponse value,
          $Res Function(FeedsFeedItemResponse) then) =
      _$FeedsFeedItemResponseCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: "id") int? id,
      @JsonKey(name: "brand_logo") String? brandLogo,
      @JsonKey(name: "image") String? image,
...
/// @nodoc
class _$FeedsFeedItemResponseCopyWithImpl<$Res>
    implements $FeedsFeedItemResponseCopyWith<$Res> {
  _$FeedsFeedItemResponseCopyWithImpl(this._value, this._then);

  final FeedsFeedItemResponse _value;
  // ignore: unused_field
  final $Res Function(FeedsFeedItemResponse) _then;
...
class _$FeedItemCopyWithImpl<$Res>
    extends _$FeedsFeedItemResponseCopyWithImpl<$Res>
...
class _$FeedItem implements FeedItem {
  ...
  @override
  String toString() {
    return 'FeedsFeedItemResponse(id: $id, brandLogo: $brandLogo, image: $image, title: $title, shortDescription: $shortDescription, description: $description, createdAt: $createdAt)';
  }
...
abstract class FeedItem implements FeedsFeedItemResponse {
