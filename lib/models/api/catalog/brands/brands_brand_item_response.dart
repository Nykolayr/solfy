...
part 'brands_brand_item_response.freezed.dart';
part 'brands_brand_item_response.g.dart';

@freezed
// ignore_for_file: invalid_annotation_target
class BrandsBrandItemResponse with _$BrandsBrandItemResponse {
  const factory BrandsBrandItemResponse(
  ...
  factory BrandsBrandItemResponse.fromJson(Map<String, dynamic> json) =>
      _$BrandsBrandItemResponseFromJson(json);
}
