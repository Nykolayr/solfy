...
class FloatModalEmailSend extends StatefulWidget {
  @override
  State<FloatModalEmailSend> createState() => _FloatModalEmailSendState();
}

class _FloatModalEmailSendState extends State<FloatModalEmailSend> {
  @override
