    ...
    return Row(
      ...
      children: [
        FormInputWithText(
          ...
          validators: [
            FormBuilderValidators.required(context, errorText: "Заполните поле"),
            FormBuilderValidators.minLength(context, 2, errorText: "В серии 2 символа"),
          ],
        ...
        FormInputWithText(
          ...
          validators: [
            ...
            FormBuilderValidators.minLength(context, 7, errorText: "В номере 7 символов"),
          ],
          hintText: "0000000",
